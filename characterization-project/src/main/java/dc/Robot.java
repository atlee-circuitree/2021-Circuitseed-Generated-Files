...
//All of these commented imports and some minor fixes (mostly removing smartdashboard stuff) done by Simon
...
public class Robot extends TimedRobot {
  ...
  */
  ...
  public void autonomousPeriodic() {
    ...
    //Changed this at 9:26 to try to invert encoders
    double rightPosition = rightEncoderPosition.get() * -1;
    double rightRate = rightEncoderRate.get() * -1;
